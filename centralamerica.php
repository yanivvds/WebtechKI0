    ...
    <div class="capage">
        <div class="ca-container">
            ...
            <div class="grid-text1">
                ...
                <p>Central America, a region connecting North and South America,<br> is a tapestry of diverse landscapes, vibrant cultures, and rich history.<br>
                Comprising seven countries:<br> Belize, Costa Rica, El Salvador, Guatemala, Honduras, Nicaragua, and Panama.<br>Central America offers a kaleidoscope of experiences for travelers.<br>
                From the ancient Mayan ruins in Guatemala<br> to the pristine beaches of Costa Rica and the lush rainforests of Belize,<br> each country is a unique gem waiting to be explored.<br>
                Dive into the warmth of local traditions, savor delicious cuisines,<br>and embark on adventures that range from <br>exploring volcanoes to lounging on tropical shores.<br>
                Central America beckons with its natural beauty, cultural richness,<br>and a warm welcome that leaves a lasting impression on every visitor.
                </p>
            </div>
